...
export function createInitialState(seed: number): GameState {
  ...
  for (const is of ITEM_SEEDS) {
    items[is.id] = {
      id: is.id,
      name: is.name,
      forceBonus: is.forceBonus,
      intelBonus: is.intelBonus,
      movementBonus: is.movementBonus,
      troopTypeOverride: is.troopTypeOverride,
    ...
    ...DEBUT_ITEM_SEEDS.map(
      (s): DebutEntry => ({
        ...
        item: {
          ...
          intelBonus: s.intelBonus,
          movementBonus: s.movementBonus,
          troopTypeOverride: s.troopTypeOverride,
          discovered: false,
          recruiterId: s.recruiterId,
        },
      })
