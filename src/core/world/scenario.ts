...
import cityCatalogJson from './scenarios/cities.json'
import officerCatalogJson from './scenarios/officers.json'
import itemCatalogJson from './scenarios/items.json'
import adjacencyJson from './scenarios/adjacency.json'
import period1Json from './scenarios/period-1.json'
import period2Json from './scenarios/period-2.json'
import period3Json from './scenarios/period-3.json'
import period4Json from './scenarios/period-4.json'
