...
export type DebutEntry =
  | { readonly type: 'officer'; readonly debutYear: number; readonly targetCityId: CityId | null
      readonly officer: Omit<Officer, 'cityId'> } // officer.lordId === null（无主）；recruiterId 已设
  | { readonly type: 'item'; readonly debutYear: number; readonly targetCityId: CityId | null
      readonly item: Omit<Item, 'holder'> }       // item.discovered === false；recruiterId 已设
...
export function officersInCity(state: GameState, cityId: CityId, opts?: { onlyAvailable?: boolean }): Officer[]
